...
export function Footer() {
  return <footer className="footer">
    <div className="container footer-inner">
      <div><div className="footer-identity"><span className="footer-logo"><Image src="/images/logo.png" alt="" width={44} height={44} /></span><div><div className="footer-brand">โรงเรียนอนุบาลมิตรอุดม</div><p>Mitudom Kindergarten</p></div></div><p>Happy Childhood. Ready for What’s Next.</p></div>
